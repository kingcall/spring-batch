...
import com.kingcall.batch.utils.FileItemReader;
import com.kingcall.batch.utils.FileItemWriter;
...
public class StepParametersApplicationJob implements StepExecutionListener {
    @Autowired
    ...
    public Step stepParametersJobStep2() {
        return stepBuilders
                ...
                .reader(flatFileItemReader(path))
